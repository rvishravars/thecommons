...
export default function ContributorsList({ contributors, loading, isCollapsed, onToggle }) {
    ...
    return (
        <div className="mb-4 rounded-lg border theme-border theme-card-soft group overflow-hidden relative">
            <button
                onClick={onToggle}
